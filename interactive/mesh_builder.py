...
from traitsui.api import View, Item, HGroup, VFlow, VGroup, Tabbed, CheckListEditor, RangeEditor, EnumEditor, ListEditor, InstanceEditor, Spring, spring, TextEditor
...
class Viewer(HasTraits):
	...
	elementToAdd = element_types.element_types.keys()[0]
	elementTypes = List(element_types.element_types.keys())
