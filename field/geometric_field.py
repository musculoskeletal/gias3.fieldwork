        ...
        if coordinates:
            ...
            for e_i in elem_numbers:
                if self.ensemble_field_function.mesh.elements[e_i].is_element:
                    ...
                    elem_nodes = [v[0][0] for v in list(self.ensemble_field_function.mapper._element_to_ensemble_map[e_i].values())]
                    coords.append(all_node_coords[elem_nodes,:].mean(0))
                else:
                    # find centre of mass of region nodes
                    region_ens_points = [ v[0][0] for v in list(self.ensemble_field_function.mapper._element_to_ensemble_map[e_i].values()) ]
